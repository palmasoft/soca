...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      <li><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
                            <img src="plantillas/AdminLTE-2.3.6/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                            Support Team
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="plantillas/AdminLTE-2.3.6/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="plantillas/AdminLTE-2.3.6/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
                <li><a href="plantillas/AdminLTE-2.3.6/index2.html"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
            ...
            <li><a href="plantillas/AdminLTE-2.3.6/documentation/index.html"><i class="fa fa-book"></i> <span>Documentation</span></a></li>
    ...
    <!-- AdminLTE App -->
    <script src="plantillas/AdminLTE-2.3.6/dist/js/app.min.js"></script>
